(function () {
  ...
  // Enable The Popup remover (you have the Undetected Ad blocker)
  ...
  const updateModal = {
    enable: true, //  Replaces default window popup with a custom modal
    timer: 5000,
  };

  let currentUrl = window.location.href;

  // Assume ad found is False
  let isAdFound = false;

  //No of Loops with a ad active
  let adLoop = 0;
  ...
  function removePageAds() {
    ...
    log('Succesfully removed ad pages !');
  }
